...
public class BonoDTO {
   ...
   // private final int MAX_RESERVAS = 5;
	...
	public BonoDTO(String idBono, String idUsuario, LocalDate fechaCreacion, tamanopista tipoPista) {
		this.idBono = idBono;
	...
	public BonoDTO(String idBono, String idUsuario, int numeroSesion, LocalDate fechaCreacion, LocalDate fechaCaducidad, tamanopista tipoPista) {
		this.idBono = idBono;
		this.idUsuario = idUsuario;
