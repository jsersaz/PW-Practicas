 ...
 * Extiende la clase abstracta {@link ReservaDTO} e incluye atributos adicionales para el
...
public class ReservaFamiliarDTO extends ReservaDTO {
     ...
     */
    public ReservaFamiliarDTO(String idReserva, String idUsuario, LocalDate fecha, int duracion, String idPista, float precio, float descuento, int numeroAdultos, int numeroNinos) {
     ...
     */
    public ReservaFamiliarDTO(String idReserva, String idUsuario, LocalDate fecha, int duracion, String idPista, float precio, float descuento, int numeroAdultos, int numeroNinos, String idBono, int numeroSesion) {
