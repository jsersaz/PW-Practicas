...
public class ReservaDTO {
     ...
     */
    public ReservaDTO(String id_reserva, String id_usuario, LocalDate fecha, int duracion, String id_pista, float precio, float descuento) {
     ...
     */
    public ReservaDTO(String id_reserva, String id_usuario, LocalDate fecha, int duracion, String id_pista, float precio, float descuento, String idBono, int numeroSesion) {
        this.idReserva = id_reserva;
        this.idUsuario = id_usuario;
        this.fecha = fecha;
        this.duracion = duracion;
