 ...
 */
public class gestordereservasDAO {
    ...
    private static gestordereservasDAO gestor; // Instancia única del gestor
     ...
     */
    public static gestordereservasDAO getGestor() {
        if (gestor == null) {
            gestor = new gestordereservasDAO();
        }
        return gestor;
    }
