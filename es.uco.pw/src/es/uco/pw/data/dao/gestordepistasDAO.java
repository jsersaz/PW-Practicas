 ...
 */
public class gestordepistasDAO {

    private ArrayList<PistaDTO> pistas;

    private static gestordepistasDAO instanciaUnica;
     ...
     */
    public static gestordepistasDAO getInstance() {
        if (instanciaUnica == null) {
            instanciaUnica = new gestordepistasDAO();
        }
