...
public class ConcreteReservaFactory extends AbstractReservaFactory{
	public AbstractReserva crearReservaIndividual(String tipo, String idReserva, LocalDate fecha, int duracion, int idPista, float precio, float descuento, int... participantes) {
	...
	public AbstractReserva crearReservaBono(String tipo, String idReserva, LocalDate fecha, int duracion, int idPista, float precio, float descuento, String idBono, int numeroSesion, int... participantes) {
		switch(tipo.toLowerCase()) {
			case "infantil":
