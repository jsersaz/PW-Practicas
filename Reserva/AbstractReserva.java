...
public abstract class AbstractReserva {
	...
	public AbstractReserva(String id_reserva, LocalDate fecha, int duracion, int id_pista, float precio, float descuento) {
	...
	public AbstractReserva(String id_reserva, LocalDate fecha, int duracion, int id_pista, float precio, float descuento, String idBono, int numeroSesion){
		this.idReserva = id_reserva;
		this.fecha = fecha;
		this.duracion = duracion;
		this.idPista = id_pista;
