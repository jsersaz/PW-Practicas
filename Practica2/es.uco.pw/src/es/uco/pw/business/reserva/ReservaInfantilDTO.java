 ...
 * Extiende la clase {@link ReservaDTO} y añade el atributo específico para el número de niños.
 */
public class ReservaInfantilDTO extends ReservaDTO {
     ...
     */
    public ReservaInfantilDTO(String idReserva, String idUsuario, LocalDate fecha, int duracion, String idPista, float precio, float descuento, int numeroNinos) {
     ...
     */
    public ReservaInfantilDTO(String idReserva, String idUsuario, LocalDate fecha, int duracion, String idPista, float precio, float descuento, int numeroNinos, String idBono, int numeroSesion) {
