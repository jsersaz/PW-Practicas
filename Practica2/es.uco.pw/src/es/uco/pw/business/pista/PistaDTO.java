...
public class PistaDTO {
	...
	private ArrayList<MaterialDTO> materialAsociados; // materiales asociados para su uso en la pista
	private int id;
	 ...
	 */
	public PistaDTO(String nombre, boolean estado, boolean tipoInterior, tamanopista tamano, int maxJugadores) {
	    this.nombre = nombre;
	    this.estado = estado;
	...
	public PistaDTO(String nombre, boolean estado, boolean tipoInterior, tamanopista tamano, int maxJugadores, ArrayList<MaterialDTO> materialesAsociados) {
	    this.nombre = nombre;
	    this.estado = estado;
	    this.tipoInterior = tipoInterior;
	    this.tamano = tamano;
	    this.maxJugadores = maxJugadores;
	    this.materialAsociados = materialesAsociados;
	}
	 ...
	 */
	public ArrayList<MaterialDTO> getMaterialAsociados() {
	 ...
	 */
	public void setMaterialAsociados(List<MaterialDTO> materialAsociados) {
		this.materialAsociados = (ArrayList<MaterialDTO>) materialAsociados;
	}
    ...
    { 
        ...
        for(MaterialDTO m : this.materialAsociados)
        {
	 ...
	 */
	public boolean asociarMaterial_Pista(MaterialDTO material) {
		int cPelotas = 0;
		int cCanastas = 0;
		int cConos = 0;
		
		// Contar los materiales ya asociados
		for(MaterialDTO m : materialAsociados) {
			switch (m.getTipo()) {
			case Tipo.pelotas: 
				cPelotas++;
				break;
		...
		material.setPistaAsociada(this);
		return true;
	}
