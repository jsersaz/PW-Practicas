        ...
        while (opcion != 7) {
            ...
            switch (opcion) {
                case 1:
                    ...
                    Jugador jugador = gestor.obtenerJugador(dni);
                    ...
                    Pista pista = gestor.obtenerPista(nombre);
                ...
                case 4:
                    ...
                    Reserva reserva = gestor.obtenerReserva(idReservaCancelar);
                ...
                case 6:
                    ...
                    ArrayList<Reserva> reservasPorDiaYPista = gestor.consultarReservasPorDiaYPista(fechaConsulta, idPista);
                    System.out.println("Reservas para " + fechaConsulta + " en la pista '" + idPista + "':");
                    for (Reserva reservaBuscar : reservasPorDiaYPista) {
