...
public class Material {
	 ...
	 */
	public Material(int identificador, Tipo tipo, boolean uso_exterior, Estado estado, Pista pista) {
		this.identificador = identificador;
		this.tipo = tipo;
		this.uso_exterior = uso_exterior;
		this.estado = estado;
		this.pistaAsociada = pista;
	}
	 ...
	 *
	 * @param pista La pista con la cual se desea asociar el material.
	 */
	public void setPistaAsociada(Pista pista)
	{
        this.pistaAsociada = pista;
    }
