...
public class Pista {
	...
	public Pista(String nombre, boolean estado, boolean tipoInterior, tamanopista tamano, int maxJugadores, ArrayList<Material> materialesAsociados) {
	    this.nombre = nombre;
	    this.estado = estado;
	    this.tipoInterior = tipoInterior;
	    this.tamano = tamano;
	 ...
	 */
	public ArrayList<Material> getMaterialAsociados() {
