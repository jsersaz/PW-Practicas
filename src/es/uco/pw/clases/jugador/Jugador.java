...
public class Jugador {
	 ...
	 private String nombre;
	     ...
	     */
	    public Jugador(String nombre, String apellidos, LocalDate fechaNacimiento, String email, String dni ) {
	        this.nombre = nombre;
	     ...
	     */
	    public Jugador(String nombre, String apellidos, LocalDate fechaNacimiento, LocalDate fechaInscripcion, String email, String dni ) {
	        this.nombre = nombre;
	        this.apellidos = apellidos;
	        this.fechaNacimiento = fechaNacimiento;
