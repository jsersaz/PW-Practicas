...
/**
 * Clase que representa una reserva para adultos, que extiende la clase {@link Reserva}.
...
public class ReservaAdultos extends Reserva {
     ...
     */
    public ReservaAdultos(String idReserva, String idUsuario, LocalDate fecha, int duracion, String idPista, float precio, float descuento, int numeroParticipantes) {
     ...
     */
    public ReservaAdultos(String idReserva, String idUsuario, LocalDate fecha, int duracion, String idPista, float precio, float descuento, int numeroParticipantes, String idBono, int numeroSesion) {
